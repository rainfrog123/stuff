...
(function () {
    ...
    function secureRandom(min, max) {
        ...
        return min + (array[0] / (0xFFFFFFFF + 1)) * (max - min); // Returns a number in range [min, max)
    }
    ...
    function placeBet(targetButton, betAmount) {
        ...
        for (let i = 0; i < clicksNeeded; i++) {
            ...
            }, i * 5 + Math.floor(secureRandom(1, 3))); // 50ms base delay + random 10-30ms
        }
    }

    // Initialize with truly random wait rounds between 1-3
    let roundsToWait = Math.floor(secureRandom(1, 4)); // 1-3 rounds
    ...
    function calculateBetAmount() {
        ...
        const r1 = secureRandom(0, 1);
        const r2 = secureRandom(0, 1);
        const r3 = secureRandom(0, 1);
    ...
    function handleBet() {
        ...
        currentRoundCount = 0;
        roundsToWait = Math.floor(secureRandom(1, 4));
        ...
        const delay = Math.floor(secureRandom(3000, 5000));
        setTimeout(() => {
