...
(function () {
    ...
    let roundsToWait = Math.floor(secureRandom(2, 6)); // Wait between 2-5 rounds before betting
    ...
    function handleBet() {
        ...
        roundsToWait = Math.floor(secureRandom(2, 6)); // Set new random rounds to wait
        ...
        let randomBetFactor = secureRandom(0.1, 0.9); // Random factor between 0.1 - 0.9
        ...
        const betChoice = secureRandom(0, 1) < 0.5 ? "Player" : "Banker";
